...
public class PinpadActivity  extends MainActivity{
    ...
    //Обработчик сообщений от клавиш. Код клавиши это текст кнопки, поэтому
    // все довольно просто. Запрещаем вводить ПИН длиннее четырех символов.
    // Рисуем звездочки на экране.
    ...
    //SuffleKeys. Используем функцию randomBytes из прицепленной ранее библиотеки MbedTLS
